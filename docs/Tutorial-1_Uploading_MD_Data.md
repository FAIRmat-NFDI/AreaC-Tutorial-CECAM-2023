...
The final section, (4) Publish_, lets the user to publish the data with or without an embargo. This will be explained more in detail in [How-to publish data](https://nomad-lab.eu/prod/v1/docs/data/upload.html).
