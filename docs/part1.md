...
TODO - Add some exercises to filter for MD trajs, Gromacs/Lammps data, etc. We could add the dataset search here and then ask them to save this in a tab for later?
...
TODO - let's ask them to search around the metainfo a bit, or maybe walk them through the relevant sections for computation (can be copied from Chema's docs)
...
TODO - Add brief summary of AI toolkit + NORTH??